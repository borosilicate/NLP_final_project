...
% to compile a camera-ready version, add the [final] option, e.g.:
     \usepackage[final]{/Users/michaelhearn/neurips_2019}
...
\author{%
  ...
  Athens, GA 30605 \\
  \texttt{michaeljosephhearn@gmail.com} \\
...
\begin{abstract}
   We explored methodologies for generating and visualizing novel metrics of agency and communion in various documents.
   Using synonyms of labels thematically connected to agency and communion and cross referencing them with vectorized word 
   similarity we were able to create a methodology for scoring words based on their similarity to the theme of agency and communion.
